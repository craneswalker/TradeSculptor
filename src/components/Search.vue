<template>
  <div id="Search">
    <div class="form-group justify-content-center text-center">
      ...
      <input v-model="cardName" @keyup.enter="loadCards(cardName)" class="search form-control form-control-lg text-center" type="text" placeholder="Card Name" id="inputLarge"/>
      <br>
      <button @click="loadCards(cardName)" type="submit" class="btn btn-primary">Find</button>
    </div>
    <div>
      <ul>
        <li class="text-center" v-for="listOfCard in listOfCards" :key="listOfCard.set">
